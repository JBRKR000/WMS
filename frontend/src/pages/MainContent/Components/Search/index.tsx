            ...
            <div style={{ backgroundColor: 'var(--color-surface)' }} className="p-6 max-h-96 overflow-y-auto space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div style={{ backgroundColor: 'var(--color-surface-secondary)' }} className="rounded p-3">
                    <div style={{ color: 'var(--color-text-secondary)' }} className="text-xs font-semibold">Jednostka</div>
                    <div style={{ color: 'var(--color-text)' }} className="font-medium mt-1 text-sm">{preview.unit ?? '-'}</div>
                  </div>
                </div>
              </div>
