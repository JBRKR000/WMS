...
const OutboundSummary: FC = () => {
  ...
  // Fetch transakcji typu ISSUE_TO_PRODUCTION, ISSUE_TO_SALES, ORDER
  useEffect(() => {
    const fetchTransactions = async () => {
      try {
        ...
        // Fetch transakcji typu ISSUE z paginacją
        const res = await fetch('/api/transactions/issues/paginated?page=0&size=1000', {
  ...
  // Dane do wykresu obszarowego - wydania w czasie (z filtrem dat)
  ...
  return (
    <main className="p-4 md:p-6 lg:p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div style={{ 
          ...
          <div className="flex items-center justify-between">
            <div>
              <div style={{ color: 'var(--color-accent)' }} className="text-xs font-semibold">Ilość wydań</div>
              <div style={{ color: 'var(--color-text)' }} className="text-3xl font-bold mt-2">{totalIssues}</div>
            </div>
      ...
      <section className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-6">
        <div style={{ 
          ...
          <div className="flex items-center justify-between mb-4">
            <h3 style={{ color: 'var(--color-text)' }} className="text-lg font-semibold">Lista wydań</h3>
            <div style={{ color: 'var(--color-text-secondary)' }} className="text-sm">{filtered.length} wyników</div>
          </div>

          {filtered.length === 0 ? (
            <div style={{ color: 'var(--color-text-secondary)' }} className="p-8 text-center">Brak wydań</div>
          ) : (
            <>
        ...
        <aside style={{ 
          ...
          <div className="flex items-center justify-between mb-4">
            <h4 style={{ color: 'var(--color-text)' }} className="text-sm font-semibold">Wydania w czasie</h4>
            {(from || to) && (
              <div style={{ 
      ...
      <section style={{ 
        ...
        <div className="flex items-center justify-between mb-4">
          <h4 style={{ color: 'var(--color-text)' }} className="text-lg font-semibold">Top 5 wydawanych pozycji</h4>
          {(from || to) && (
            <div style={{ 
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div style={{ 
            ...
            <div style={{ 
              ...
              <div>
                <h3 className="text-2xl font-bold">Szczegóły wydania #{detail.id}</h3>
            ...
            <div style={{ backgroundColor: 'var(--color-surface)' }} className="p-6 max-h-96 overflow-y-auto space-y-6">
              ...
              <div style={{ 
                ...
                <div>
                  <div style={{ color: 'var(--color-text-secondary)' }} className="text-xs font-semibold mb-1">Użytkownik wydający</div>
              ...
              <div className="grid grid-cols-3 gap-2 text-xs">
                ...
                <div style={{ 
                  ...
                  <div style={{ color: 'var(--color-warning-text)' }} className="text-xs font-semibold">Status</div>
                  <div style={{ color: 'var(--color-warning)' }} className="font-bold mt-1 flex items-center justify-center gap-1">
