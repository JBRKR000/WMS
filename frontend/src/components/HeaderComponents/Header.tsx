...
const Header: FC = () => {
  ...
  const navItems: NavItem[] = [
    ...
    { to: '/components', icon: ShoppingCart, label: 'Komponenty' },
    { to: '/issues', icon: TruckIcon, label: 'Wydania' },
    { to: '/orders', icon: Box, label: 'Zamówienia' },
    { to: '/raports', icon: ChartColumnIcon, label: 'Raporty' },
    ...
    <header className="shadow bg-surface">
      <div className="px-4 py-4">
        ...
        <div className={`lg:hidden overflow-hidden transition-all duration-300 ease-in-out ${
          ...
          <div className="mt-4 py-4 border-t border-main">
